## From Chaos to Clarity: Building a Production-Grade Event-Driven Serverless Platform

This repository represents the transformation of a messy, tightly coupled event-driven architecture into a well-structured, scalable, and reusable serverless platform built entirely with Terraform and Java-based AWS Lambda. What started as an ad-hoc infrastructure setup evolved into a clear separation of concerns—application code, environment configuration, and infrastructure modules—designed with real-world production standards in mind.
...
![Terraform management](image.png)
